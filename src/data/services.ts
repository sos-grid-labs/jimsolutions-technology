...
export const SERVICES: ServiceItem[] = [
  {
    ...
    shortDesc: 'Installation, maintenance, repairs, fault diagnosis, and annual service contracts for luxury home appliances.',
    longDesc:
  ...
  },
  {
    ...
    shortDesc: 'Built-in appliance installations, kitchen furniture integration, and precise system commissioning.',
    longDesc:
  ...
  },
  {
    ...
    shortDesc: 'Setup, diagnostic calibration, and repairs for premium wine coolers and built-in refrigerators.',
    longDesc:
  ...
  },
  {
    ...
    shortDesc: 'Commercial and residential laundry setups, washer and dryer repairs, and preventive maintenance.',
    longDesc:
    ...
    icon: faSoap,
    image: '/img/services/luxury-laundry-room.png',
  ...
  },
  {
    ...
    shortDesc: 'Solar panel array installations, hybrid inverter configurations, and battery storage backup setups.',
    longDesc:
      'Secure your power grid with clean energy. We conduct technical load assessments to design and install custom solar arrays, size inverter capacities, and integrate battery backups for luxury residences and commercial facilities.',
    icon: faSun,
